...
def get_data_from_json(raw_json_data):
    ...
    try:
        ...
        # print('+'*50)
        # print(json_data.get('cat2').get('searchResults').get('listResults', []))
        # print('+'*50)

        search_results = json_data.get('cat1').get('searchResults').get('listResults', [])

        properties = search_results[1]
        #print(properties.get('hdpData', {}).get('homeInfo'))
